...
def run(j):
    ...
    #ran_y_train = ran_y_train.astype('int32')
    ...
    for pc in range(len(full_tr_pairs) - 1):
        ...
        ratio_bad = 1.0
        ratio = 0.0
        pc_a = full_tr_pairs[pc][0]
        pc_b = full_tr_pairs[pc][1]
    ...
    for i in range(19):
        ...
        #Transform intermediate output into a list for easier use
                ...
                for neighbour_b in neighbours_b:
                    ...
                    if(neighbour_a_label == neighbour_b_label):
                        ...
                        if(full_tr_y[pc] == 1):
                            ...
                            ratio_good  += 1
            ratio = ratio_good / ratio_bad
            pair_ranking += [[ratio, full_tr_pairs[pc], full_tr_y[pc], pairs_a[pc], pairs_b[pc]]]
    ...
    file = open("Dynee_Ord/results" + str(j) + ".txt", "w")
